...
const EditExistingEvaluationsTable = ({ existingEvaluations }) => {
                    ...
                    {existingEvaluations && existingEvaluations.length > 0 ? (
                        existingEvaluations.map((evalItem, idx) => (
                            <tr key={evalItem._id}>
                                ...
                                <td>
                                    <Link to={`/llm-response-evaluation/${evalItem._id}/edit`} className="text-decoration-none text-primary">
                                        {evalItem.title}
                                    </Link>
                                </td>
...
export default EditExistingEvaluationsTable;